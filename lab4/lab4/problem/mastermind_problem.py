...
# -------------------------------------------------------------------------------------------------
# Auxilary variables - Encoding and Default Decision Variables 
...
dv_mastermind_template = {
    ...
    "Colors-Code-SGRB-BG"   : ["da_blue", "da_red", "da_yellow", "da_white", "da_magenta" ] # Dark_<color> Sty colors
}
...
class MastermindProblem(ProblemTemplate):
    ...
    * Sty is a python color package
    ...
    #----------------------------------------------------------------------------------------------
    def is_admissible( self, solution ): #<< use this signature in the sub classes, the meta-heuristyics 
        """
    ...
    def _objective_function1(self, solution, decision_variables, feedback = None): #<< use this signature in the sub classes, the meta-heuristyics 
        """
...
# -------------------------------------------------------------------------------------------------
# Nieghborhood Function [get_neighbors()]
# -------------------------------------------------------------------------------------------------
