...
from lab4.problem.problem_template import ProblemObjective, ProblemTemplate
from lab4.util.observer            import LocalSearchMessage
...
class HillClimbing:
    ...
    # Constructor
    #----------------------------------------------------------------------------------------------
    def __init__(self, problem_instance, neighbohood_function, feedback = None, params = {} ): 
        """
        Simulated Annelaing Constructor

        Parameters:
        -----------
        ▶ problem_instance     - the instance of the problem that the algorithm will search a solution

        ▶ neighbohood_function - it is expected a function that must folow the signature:
           
            neighbohood_function( solution, problem, neighborhood_size = 0 )
        
        ▶ feedback 

        ▶ params - dictionary with configurations for Hill Climnbing
        ...
        self._get_neighbors     = neighbohood_function
        ...
        # parse params
        # Default params: 
        # {"Maximum-Iterations": 10, "Stop-Conditions":"Classical", "Target-Fitness" : None, "Neighborhood-Size" = -1 } 
